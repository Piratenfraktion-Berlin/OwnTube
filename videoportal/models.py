...
class Video(models.Model):
    ...
    videoThumbURL = models.URLField("Audio Thumb-URL",blank=True,verify_exists=False)
    audioThumbURL = models.URLField("Video Thumb-URL",blank=True,verify_exists=False)
